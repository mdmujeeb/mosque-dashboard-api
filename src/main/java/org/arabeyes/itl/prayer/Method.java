...
public class Method {
	...
	public static final Method NONE = new Method("NONE", 0.0, 0.0, Utils.DEF_IMSAAK_ANGLE, 0, 0, 0, Rounding.SPECIAL, Madhhab.SHAFII,
     ...
     *  </ul>
	 */
	public static final Method EGYPT_SURVEY = new Method("EGYPT_SURVEY", 20, 18, Utils.DEF_IMSAAK_ANGLE, 0, 0, 0, Rounding.SPECIAL,
     ...
     *       </li></ul>
     */ 
	public static final Method KARACHI_SHAF = new Method("KARACHI_SHAFI", 18, 18, Utils.DEF_IMSAAK_ANGLE, 0, 0, 0, Rounding.SPECIAL,
			Madhhab.SHAFII, Utils.DEF_NEAREST_LATITUDE, ExtremeLatitude.GOOD_INVALID, false, 0, 0, 0, 0, 0, 0);
     ...
     *   </ul>                                
	 */
	public static final Method KARACHI_HANAF = new Method("KARACHI_HANAFI", 18, 18, Utils.DEF_IMSAAK_ANGLE, 0, 0, 0,
     ...
     *   </ul>                  
	 */
	public static final Method NORTH_AMERICA = new Method("NORTH_AMERICA", 15, 15, Utils.DEF_IMSAAK_ANGLE, 0, 0, 0,
     ...
     *              
	 */
	public static final Method MUSLIM_LEAGUE = new Method("MUSLIM_LEAGUE", 18, 17, Utils.DEF_IMSAAK_ANGLE, 0, 0, 0,
			Rounding.SPECIAL, Madhhab.SHAFII, Utils.DEF_NEAREST_LATITUDE, ExtremeLatitude.GOOD_INVALID, false, 0, 0, 0, 0, 0, 0);
     ...
     *   </ul>                         
	 */
	public static final Method UMM_ALQURRA = new Method("UMM_AL-QURRA", 19, 0, Utils.DEF_IMSAAK_ANGLE, 0, 90, 0, Rounding.SPECIAL,
			Madhhab.SHAFII, Utils.DEF_NEAREST_LATITUDE, ExtremeLatitude.GOOD_INVALID, false, 0, 0, 0, 0, 0, 0);
     ...
     *   </ul> 
	 */
	public static final Method FIXED_ISHAA = new Method("FIXED_ISHAA", 19.5, 0, Utils.DEF_IMSAAK_ANGLE, 0, 90, 0,
			Rounding.SPECIAL, Madhhab.SHAFII, Utils.DEF_NEAREST_LATITUDE, ExtremeLatitude.GOOD_INVALID, false, 0, 0, 0, 0, 0, 0);
	 ...
	 */
	public Method(String name, double fajrAng, double ishaaAng, double imsaakAng,
